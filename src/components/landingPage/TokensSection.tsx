    ...
    <div className="bg-[#f0f4ff] py-20 px-6 md:px-12">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-16 max-w-2xl mx-auto">
          ElementPay is transforming how Kenyans make payments—whether for your
          daily commute, shopping, or paying your local vendor. Here&apos;s how
          we&apos;re making it easier for everyday transactions.
        </p>
