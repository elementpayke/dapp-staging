...
interface SendCryptoReceiptProps {
    isOpen: boolean;
    onClose: () => void;
    transactionReciept: any;
}

export default function SendCryptoReceipt({ isOpen, onClose, transactionReciept }: SendCryptoReceiptProps) {
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col items-center space-y-2">
                    ...
                    >Payment {transactionReciept.status === 0 ? "not sent" : "sent"}</p>
                </div>
