...
import { useContractHandleOrderStatus, useContractEvents } from "@/context/useContractEvents";
...
export default function Page() {
    ...
    useContractEvents(
        ...
        (orderId: any) =>  console.log("OrderRefunded")
    );  
    ...
    const handleSendCrypto = async () => { 
        ...
        if (usdcBalance === null || isNaN(Number(usdcBalance))) {
